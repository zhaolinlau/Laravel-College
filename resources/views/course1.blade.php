    ...
    <div class="col-md-6">
       <!--begin drop-down-->
        ...
        <li>
            ...
            <ul style="display:block;">
                <li> style ="list-style-type: none;">
                    <ol type="i">
                        <li class="course-text" stye="text-align: justify;">
                            ::marker
            ...
            <ul style="display: none;">
                ...
                <li>
                    ...
                    <ul>
                        <li class="course-text">
                            ...
                            <br>
                            "Digital Sound Protection"
                            <br>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="parent">Elective Subjects</a>
                    <ul>
                        <li class="course-text">
                ...
                <li>
                    <a href="#" class="parent">University Subjects</a>
                    <ul>
                        <li class="course-text">
        ...
        <li>
            ...
            <ul style="display: none;">
                <li class="course-text">
                    "New Media artist, UX/UI Interface designer,Real-time event 
