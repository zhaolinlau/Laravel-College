...
@section('content')
	@include('layouts.navbar')
        ...
        <div class="container">
            <div class="row">
                <b><h3 style="padding:10px; margin-top: 20px; margin-bottom: 40px;">UPDATE FAQ FOR PROGRAMME</h3></b>

                <div class="col-6" style="margin:auto;">
                    <form action="/faqstaff/{{$data_faqprogramme->id}}/updateProgramme" method="POST">
                    {{csrf_field()}}
